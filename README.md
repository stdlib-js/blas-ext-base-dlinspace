...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-dlinspace/tags). For example,

```javascript
dlinspace = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dlinspace@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dlinspace/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-dlinspace/actions/workflows/test.yml?query=branch:v0.1.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-dlinspace.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-dlinspace/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-dlinspace/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-dlinspace/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-dlinspace/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-dlinspace/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-dlinspace/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-dlinspace/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-dlinspace/blob/main/branches.md
